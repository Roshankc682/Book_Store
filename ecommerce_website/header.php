...
<!-- =====search bar====== -->
     ...
     <link rel="stylesheet" type="text/css" href="All_style/rating.css">
<!-- ===search bar end==== -->
    ...
    <?php
          ...
          if (isset($_SESSION['name'])) 
        {
          ...
          echo '    <div class="topnav" id="myTopnav">
                      ...
                      <a href="viewcart.php"><i class="fas fa-shopping-cart"></i>&nbsp;Cart<sup>';?> 
                      ...
                      <a href="#">
                         ...
                         // ======end of connection====
                          ...
                          echo '<a class="a_hover_userprofile" href="setting.php?details=user&token=not_ready_yet">';
                                                ...
                                                if ($result__->num_rows > 0) {
                                                  ...
                                                  while($row = $result__->fetch_assoc()) 
                                                  {
                                                      ...
                                                      if($row["username"] == $user_name)
                                                      {
                                                            ...
                                                            $_SESSION['nickname_for_stripe_payment_checkout'] = $row['nickname'];
                                                            echo $Nickname;
                                                          }
                                                   }
                                                 }
