...
$load_more_new_clicked_after_login_for_sus = $_POST['load_more_new_clicked_after_login_for_sus'];

// echo '<script>alert(';echo $load_more_new_clicked_after_login_for_sus; echo ')</script>';
   ...
   // ======connected to book where image name author_name uploaded==========';
      ...
      $index7="category";
          ...
          $quanity_check_loop = 1;
            ...
            $query = mysqli_query($con,"SELECT * FROM book WHERE title LIKE '%$search%' OR author LIKE '%$search%' OR category LIKE '%$search%' LIMIT $load_more_new_clicked_after_login_for_sus") or die ("Could not search");
