...
$load_more_new_clicked_after_login_for_m = $_POST['load_more_new_clicked_after_login_for_m'];
   ...
   // ======connected to book where image name author_name uploaded==========';
      ...
      $index7="category";
          $quanity_check_loop = 1;
            ...
            $query = mysqli_query($con,"SELECT * FROM book WHERE title LIKE '%$search%' OR author LIKE '%$search%' OR category LIKE '%$search%' LIMIT $load_more_new_clicked_after_login_for_m") or die ("Could not search");
